...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Xena Warrior Princess",
    .project_root_env = "XENA_WARRIOR_PRINCESS_RECOMP_PROJECT_ROOT",
    .build_dir_env = "XENA_WARRIOR_PRINCESS_RECOMP_BUILD_DIR",
    .force_setup_env = "XENA_WARRIOR_PRINCESS_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.77_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Xena__Warrior_Princess_Recompiled",
    .prepare_note =
